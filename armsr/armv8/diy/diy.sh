...
git clone https://github.com/kongfl888/luci-app-adguardhome --depth=1 clone/adguardhome

# Update packages
rm -rf feeds/luci/applications/luci-app-passwall feeds/luci/applications/luci-app-openclash feeds/packages/adguardhome feeds/packages/lang/golang feeds/packages/net/mosdns feeds/packages/net/v2ray-geodata
